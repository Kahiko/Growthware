...
Public Class AccountController
    ...
    Public Async Function VerifyCode(provider As String, returnUrl As String, rememberMe As Boolean) As Task(Of ActionResult)
        ...
        If Not Await SignInManager.HasBeenVerifiedAsync() Then
            Return View("Error")
        End If
        Dim user = Await UserManager.FindByIdAsync(Await SignInManager.GetVerifiedUserIdAsync())
        If user IsNot Nothing Then
            Dim code = Await UserManager.GenerateTwoFactorTokenAsync(user.Id, provider)
        End If
