...
Namespace Common
    Public Class SortTable
        ...
        Public Sub Sort(ByVal dataTable As DataTable, ByVal dataColumn As DataColumn, ByVal sortDirection As String)
            If dataTable Is Nothing Then Throw New ArgumentNullException("dataTable", "dataTable cannot be a null reference (Nothing in Visual Basic)!")
            If dataColumn Is Nothing Then Throw New ArgumentNullException("dataColumn", "dataColumn cannot be a null reference (Nothing in Visual Basic)!")
            If String.IsNullOrEmpty(sortDirection) Then Throw New ArgumentNullException("sortDirection", "sortDirection cannot be a null reference (Nothing in Visual Basic)!")
        ...
        Public Sub Sort(ByVal dataTable As DataTable, ByVal columnName As String, ByVal sortDirection As String)
            If dataTable Is Nothing Then Throw New ArgumentNullException("dataTable", "dataTable cannot be a null reference (Nothing in Visual Basic)!")
            If String.IsNullOrEmpty(columnName) Then Throw New ArgumentNullException("columnName", "columnName cannot be a null reference (Nothing in Visual Basic)!")
            If String.IsNullOrEmpty(sortDirection) Then Throw New ArgumentNullException("sortDirection", "sortDirection cannot be a null reference (Nothing in Visual Basic)!")
            m_StartTime = DateTime.Now
            Dim rowCount As Integer = dataTable.Rows.Count - 1
            Dim sortValues(rowCount) As String
