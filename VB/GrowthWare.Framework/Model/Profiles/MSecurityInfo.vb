...
Namespace Model.Profiles
    ...
    Public Class MSecurityInfo
        ...
        ''' <remarks></remarks>
        Public Sub New(ByVal groupRolePermissionSecurity As IMGroupRolePermissionSecurity, ByVal AccountRoles As Collection(Of String))
            ' Check View Permissions
            m_MayView = CheckAuthenticatedPermission(groupRolePermissionSecurity.DerivedViewRoles, AccountRoles)
            ' Check Add Permissions
            m_MayAdd = CheckAuthenticatedPermission(groupRolePermissionSecurity.DerivedAddRoles, AccountRoles)
            ' Check Edit Permissions
            m_MayEdit = CheckAuthenticatedPermission(groupRolePermissionSecurity.DerivedEditRoles, AccountRoles)
            ' Check Delete Permissions
            m_MayDelete = CheckAuthenticatedPermission(groupRolePermissionSecurity.DerivedDeleteRoles, AccountRoles)
        End Sub 'New
        ...
        Protected Function CheckAuthenticatedPermission(ByVal objRoles As Collection(Of String), ByRef accountRoles As Collection(Of String)) As Boolean
            ...
            If accountRoles.Contains("SysAdmin") Then Return True
