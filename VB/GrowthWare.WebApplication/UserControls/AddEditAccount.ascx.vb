...
Public Class AddEditAccount1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If m_Action.ToUpper(CultureInfo.InvariantCulture).IndexOf("REGISTER") > -1 Then
                m_Profile = New MAccountProfile()
    ...
    Private Sub populatePage()
        ...
        End If
        Dim mGroupTabSecurity As MSecurityInfo = New MSecurityInfo(FunctionUtility.GetProfile(ConfigSettings.GetAppSettingValue("Actions_View_Account_Group_Tab", True)), AccountUtility.CurrentProfile)
        Dim mRoleTabSecurity As MSecurityInfo = New MSecurityInfo(FunctionUtility.GetProfile(ConfigSettings.GetAppSettingValue("Actions_View_Account_Role_Tab", True)), AccountUtility.CurrentProfile)
