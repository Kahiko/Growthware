<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LineCount.aspx.vb" Inherits="GrowthWare.WebApplication.LineCount" %>
		...
		<table border="0" cellpadding="0" cellspacing="3" width="100%">
			...
			<tr>
				<td colspan="3" align="center">
					<input type="button" id="btnCount" onclick="javascript: getCount();" value="Count" runat="server" />
				</td>
			</tr>
		</table>
