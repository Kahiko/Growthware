<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ChangePassword.aspx.vb" UnobtrusiveValidationMode="None" Inherits="GrowthWare.WebApplication.ChangePassword" %>
		...
		<table border="0" cellpadding="3" cellspacing="3" style="font: 8pt verdana, arial;">
			...
			<tr id="trOldPassword" runat="server">
				...
				<td align="left">
					...
					<asp:RequiredFieldValidator ID="RequiredFieldValidator1" SetFocusOnError="true" ErrorMessage="(required)" ControlToValidate="OldPassword" runat="server" />
				</td>
			</tr>
			<tr>
				<td align="right" valign="top">
				...
				<td align="left">
					...
					<asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="dynamic" SetFocusOnError="true" ControlToValidate="NewPassword" ErrorMessage="(required)" runat="server" />
					<asp:CompareValidator ID="CompareValidator1" ControlToCompare="OldPassword" Display="dynamic" ControlToValidate="NewPassword" Operator="NotEqual" ErrorMessage="New password can not match the old password." runat="server" />
				</td>
			</tr>
			<tr>
				<td align="right" valign="top">
				...
				<td align="left">
					...
					<asp:RequiredFieldValidator ID="RequiredFieldValidator3" SetFocusOnError="true" ErrorMessage="(required)" ControlToValidate="ConfirmPassword" runat="server" />
					<asp:CompareValidator ID="CompareValidator2" ControlToCompare="NewPassword" Display="dynamic" ControlToValidate="ConfirmPassword" Operator="Equal" ErrorMessage="New password and confirm password must match." runat="server" />
				</td>
			</tr>
			<tr>
