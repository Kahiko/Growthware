<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CommunityCalendar.aspx.vb" Inherits="GrowthWare.WebApplication.CommunityCalendar" %>

<!DOCTYPE html>

<form id="frmCommunityCalendar" runat="server">
    <div>
			        ...
			        <table width="100%" class="table table-striped table-bordered">
				        <tr>
					        ...
					        <td valign="top">
						        ...
						        <ul>
							        <li>Select the date</li>
								    <li>Copy the desired text</li>
							        <li>Paste the text into the "Comments:" box</li>
							        <li>Click Delete</li>
						        </ul>
					        </td>
				        </tr>
				        <tr>
					        <td colspan="2">
						        Comments:&nbsp;<asp:TextBox ID="txtComments" runat="server" Width="80%"></asp:TextBox></td>
				        </tr>
			        </table>
		        </td>
	        </tr>
