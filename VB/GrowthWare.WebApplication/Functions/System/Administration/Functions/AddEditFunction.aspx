...
<body>
    ...
    <form id="AddEditFunction" runat="server">
    <div>
        <div id="tabs">
            <ul>
                ...
                <p>
                    <table border="0" style="width: 100%;" cellpadding="2">
                        ...
                        <tr>
                            ...
                            <td style="width: 0px;" valign="top">
                                <img onclick="showMSG(document.getElementById('helpActions').innerHTML,2,'Action Help')" style="border: 0px;" src="<%=ResolveUrl("~/Public/Images/GrowthWare/help.gif") %>" alt="&nbsp;Help about actions&nbsp;" />
                            </td>
                            <td align="left">
                        ...
                        <tr id="trSource" runat="server">
                            ...
                            <td style="width: 0px;" valign="top">
                                <img onclick="showMSG(document.getElementById('helpSource').innerHTML,2,'Action Source')" style="border: 0px;" src="<%=ResolveUrl("~/Public/Images/GrowthWare/help.gif") %>" alt="&nbsp;Help about source&nbsp;" />
                            </td>
                            <td align="left">
