<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SearchSecurityEntitiesResults.aspx.vb" Inherits="GrowthWare.WebApplication.SearchSecurityEntitiesResults" %>
<style type="text/css">
	noHeader
	{
		display:none;
