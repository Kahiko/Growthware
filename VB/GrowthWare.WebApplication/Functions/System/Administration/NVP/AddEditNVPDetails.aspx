<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AddEditNVPDetails.aspx.vb" Inherits="GrowthWare.WebApplication.AddEditNVPDetails" %>
	...
	<div>
		<table>
			...
			<tr>
				...
				<td colspan ="s">
					<asp:DropDownList runat="server" ID="dropStatusID" CssClass="rounded">
