<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SearchGroups.aspx.vb" Inherits="GrowthWare.WebApplication.SearchGroups" %>
...
<form id="frmSearchGroups" runat="server">
	...
	<script type="text/javascript" language="javascript">
		...
		function okDeleteFunc(jsonObj) {
			...
			options.async = true;
			options.url = GW.Common.getBaseURL() + "/Functions/System/Administration/Groups/AddEditGroup.aspx/InvokeDelete";
