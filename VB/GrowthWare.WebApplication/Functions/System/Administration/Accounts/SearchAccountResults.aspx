<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SearchAccountResults.aspx.vb" Inherits="GrowthWare.WebApplication.SearchAccountResults" %>
					...
					<asp:TemplateField>
						...
						<ItemTemplate>
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td align="center">
										<img alt="Delete" id="btnDelete" src="Public/Images/GrowthWare/delete_red.png" style="height: 16px; width: 16px;" runat="server" />
									</td>
								</tr>
							</table>
						</ItemTemplate>
