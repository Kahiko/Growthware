<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SelectGroups.ascx.vb" Inherits="BaseApplication.SelectGroups" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
