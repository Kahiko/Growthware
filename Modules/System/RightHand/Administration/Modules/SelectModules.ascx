...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SelectModules.ascx.vb" Inherits="BaseApplication.SelectModules" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<tr>
		...
		<td><!--Sort By: -->
			<asp:dropdownlist Visible="False" id="dropSortBy" Runat="Server" AutoPostBack="True">
				<asp:ListItem Text="Module Name" Value="0" />
			</asp:dropdownlist></td>
		<td>Order By:
		...
		<td align="center">
			...
			<asp:datagrid id="dgResults" runat="server" CellPadding="5" GridLines="None" BorderStyle="None"
				...
				<Columns>
					<asp:TemplateColumn>
						...
						<ItemTemplate>
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td align="center">
										<asp:HyperLink ImageUrl="AdmedEdit.gif" Text="Edit Module" NavigateUrl="SetByCodeBehind" Runat="server" ID="hyperEdit" />
									</td>
								</tr>
							</table>
						</ItemTemplate>
					...
					<asp:BoundColumn DataField="Name" HeaderText="Module Name" />
					<asp:TemplateColumn HeaderText="Module State">
						<ItemTemplate>
