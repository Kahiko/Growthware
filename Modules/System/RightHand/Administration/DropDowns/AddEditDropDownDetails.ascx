<%@ Control Language="vb" AutoEventWireup="false" Codebehind="AddEditDropDownDetails.ascx.vb" Inherits="BaseApplication.AddEditDropDownDetails" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
