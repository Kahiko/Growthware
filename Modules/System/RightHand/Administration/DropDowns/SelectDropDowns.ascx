...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SelectDropDowns.ascx.vb" Inherits="BaseApplication.SelectDropDowns" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
