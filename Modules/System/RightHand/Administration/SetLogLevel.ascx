<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SetLogLevel.ascx.vb" Inherits="BaseApplication.SetLogLevel" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
