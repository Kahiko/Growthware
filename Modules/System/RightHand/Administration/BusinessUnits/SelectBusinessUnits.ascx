...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SelectBusinessUnits.ascx.vb" Inherits="BaseApplication.SelectBusinessUnits" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
					...
					<asp:TemplateColumn>
						...
						<ItemTemplate>
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td align="center">
										<asp:HyperLink ImageUrl="AdmedEdit.gif" Text="Edit" NavigateUrl="SetByCodeBehind" Runat="server" ID="hyperEdit" />
									</td>
								</tr>
							</table>
						</ItemTemplate>
