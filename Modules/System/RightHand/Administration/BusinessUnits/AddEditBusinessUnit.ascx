<%@ Control Language="vb" AutoEventWireup="false" Codebehind="AddEditBusinessUnit.ascx.vb" Inherits="BaseApplication.AddEditBusinessUnit" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
