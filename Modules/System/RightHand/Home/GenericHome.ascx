<%@ Control Language="vb" AutoEventWireup="false" Codebehind="GenericHome.ascx.vb" Inherits="BaseApplication.GenericHome" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
