<%@ Control Language="vb" AutoEventWireup="false" Codebehind="RandomNumbers.ascx.vb" Inherits="BaseApplication.RandomNumbers" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
