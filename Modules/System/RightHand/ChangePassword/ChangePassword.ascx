<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ChangePassword.ascx.vb" Inherits="BaseApplication.ChangePassword" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
