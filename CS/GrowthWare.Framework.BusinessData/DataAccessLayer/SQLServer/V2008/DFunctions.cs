...
namespace GrowthWare.Framework.BusinessData.DataAccessLayer.SQLServer.V2008
{
	...
	///	</remarks>
    public class DFunctions : DDBInteraction, IDFunction
    {
        ...
        DataRow IDFunction.GetFunction
        {
            get
            {
                checkValid();
        ...
        DataSet IDFunction.GetFunctions
        {
            get
            {
        ...
        MFunctionProfile IDFunction.Profile
        {
            get
            {
                return m_Profile;
        ...
        int IDFunction.SecurityEntitySeqId
        {
            get
            {
        ...
        void IDFunction.Delete(int functionSeqId)
        {
            SqlParameter[] mParameters = 
			{
        ...
        DataTable IDFunction.FunctionTypes()
        {
        ...
        void IDFunction.SaveGroups(PermissionType permission)
        {
            checkValid();
        ...
        void IDFunction.SaveRoles(PermissionType permission)
        {
            checkValid();
        ...
        DataTable IDFunction.Search(MSearchCriteria searchCriteria)
        {
