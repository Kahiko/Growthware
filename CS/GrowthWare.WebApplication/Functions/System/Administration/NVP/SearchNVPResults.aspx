<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchNVPResults.aspx.cs" Inherits="GrowthWare.WebApplication.Functions.System.Administration.NVP.SearchNVPResults" %>
				...
				<asp:TemplateField>
					...
					<ItemTemplate>
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td align="center">
									<img alt="Edit Children" id="btnEditChildren" src="Content/GrowthWare/Images/list-edit.png" style="height: 16px; width: 16px;" runat="server" />
								</td>
							</tr>
						</table>
					</ItemTemplate>
