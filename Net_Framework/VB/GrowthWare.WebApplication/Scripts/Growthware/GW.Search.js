...
GW.Search = {
    ...
    DefaultImageSrc: function () {
        return "Content/GrowthWare/Images/sort_asc.png";
    },
    ...
    setSortImage: function () {
        $("img[name^='headerSort']").each(function () {
            $(this).attr("src", GW.Common.getBaseURL() + "/Content/GrowthWare/Images/Spacer.gif");
        });
    ...
    init: function () {
        ...
        this.Criteria.PageSize = $('input[id*="SearchControl_txtRecordsPerPage"]').val();
    }
}
