...
if (typeof GW.Upload == "undefined" || !GW.Upload) {
	GW.Upload = {
		...
		form: function () {
			...
			retVal = retVal + "		<img alt='Upload File' onclick='javascript:alert(" + "\"" + "hi" + "\"" + ");' id='btnUpload' src='" + GW.Common.getBaseURL() + "/Content/GrowthWare/Images/Add.png' height='16px' width='16px' />";
			retVal = retVal + "	</div>"
			retVal = retVal + "	</td>";
			retVal = retVal + "	<td>";
