CREATE PROCEDURE [ZFP_SET_NVP_RLS](
	@P_NVP_SEQ_ID INT,
	@P_SE_SEQ_ID INT,
 ...
 AS
BEGIN TRAN
	-- NEED TO DELETE EXISTING ROLE ASSOCITAED WITH THE NVP BEFORE 
	-- INSERTING NEW ONES.
	EXEC ZFP_DEL_NVP_RL_SECURITY @P_NVP_SEQ_ID,@P_SE_SEQ_ID,@P_PERMISSIONS_SEQ_ID,@P_ADDUPD_BY,@P_ErrorCode
