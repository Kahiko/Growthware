...
Public Class Security
    ...
    Public Class CryptoUtil
        ...
        Public Function Encrypt(ByVal value As String, Optional ByVal Force As Boolean = False) As String
            If value <> "" Then
                If BaseSettings.enableEncryption = False And Force = False Then
                    Return value
                End If
        ...
        Public Function EncryptTripleDES(ByVal value As String, Optional ByVal Force As Boolean = False) As String
            If value <> "" Then
                If BaseSettings.enableEncryption = False And Force = False Then
                    Return value
                End If
