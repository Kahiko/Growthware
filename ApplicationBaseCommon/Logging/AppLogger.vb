...
Namespace Logging
    Public Class AppLogger
        ...
        Private Shared LogFileName As String = BaseSettings.logPath & Format(Now, "MMddyyyy") & ".txt"
        ...
        '*********************************************************************
        Private Sub init()
            myLayout.ConversionPattern = BaseSettings.conversionPattern
            myAppender.AppendToFile = BaseSettings.appendToFile
            Dim InitialLogPriority As log4net.Priority
            Select Case BaseSettings.logPriority.ToLower
                Case "debug"
        ...
        Public Shared Function GetInstance() As AppLogger
            ...
            Finally
                ...
                LogFileName = BaseSettings.logPath & Format(Now, "MMddyyyy") & ".txt"
