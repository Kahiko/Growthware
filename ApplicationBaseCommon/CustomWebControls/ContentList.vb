...
Namespace CustomWebControls
    ...
    '
    '*********************************************************************
    <ParseChildrenAttribute(True), Designer(GetType(CustomDesigner)), DefaultProperty("Text"), ToolboxData("<{0}:ContentList runat=server></{0}:ContentList>")> _
    Public Class ContentList
        ...
        Protected Sub RenderPager(ByVal writer As HtmlTextWriter)
            ...
            If CurrentPage > 1 Then
                ...
                writer.AddAttribute(HtmlTextWriterAttribute.Href, "javascript:" + Page.ClientScript.GetPostBackEventReference(Me, "prev"))
            ...
            If CurrentPage < _totalPages Then
                ...
                writer.AddAttribute(HtmlTextWriterAttribute.Href, "javascript:" + Page.ClientScript.GetPostBackEventReference(Me, "next"))
                writer.RenderBeginTag(HtmlTextWriterTag.A)
                writer.Write("&gt;&gt;")
                writer.RenderEndTag()
        ...
        Sub AddPageNumber(ByVal writer As HtmlTextWriter, ByVal pageNumber As Integer)
            ...
            If pageNumber = CurrentPage Then
                writer.Write("[")
            End If
            writer.AddAttribute(HtmlTextWriterAttribute.Href, "javascript:" + Page.ClientScript.GetPostBackEventReference(Me, pageNumber.ToString()))
