...
Namespace CustomWebControls
    <DefaultProperty("Text"), Designer(GetType(CustomDesigner)), ToolboxData("<{0}:ListPicker runat=server />")> _
    Public Class ListPicker
        ...
        Protected Overrides Sub OnDataBinding(ByVal e As EventArgs)
            ...
            If Not _isUplevel Then
                ...
                lstAllItems.Attributes.Add("Multiple", "True")
                lstAllItems.SelectionMode = ListSelectionMode.Multiple
                lstAllItems.DataSource = _allItems
                lstAllItems.DataBind()

                lstSelectedItems.Attributes.Add("Multiple", "True")
        ...
        Protected Overrides Sub CreateChildControls()
            If Not _isUplevel Then
                ...
                btnAddAllItem = New Button
                btnAddAllItem.Text = "->>"
                btnAddAllItem.CausesValidation = False
                AddHandler btnAddAllItem.Click, AddressOf btnAddAllClick
                Controls.Add(btnAddAllItem)
                ...
                btnRemoveAllItem = New Button
                btnRemoveAllItem.Text = "<<-"
                btnRemoveAllItem.CausesValidation = False
                AddHandler btnRemoveAllItem.Click, AddressOf btnRemoveAllClick
                Controls.Add(btnRemoveAllItem)
            End If
        ...
        Sub RenderUplevelContent(ByVal writer As HtmlTextWriter)
            ...
            writer.RenderBeginTag(HtmlTextWriterTag.Select)         ' <select>
            ...
            ' Add Button
            writer.AddAttribute(HtmlTextWriterAttribute.Onclick, String.Format("switchList(this.form.{0}_SrcList, this.form.{0}_DstList)", ClientID))
            writer.AddAttribute(HtmlTextWriterAttribute.Class, "listPickerArrow")
            writer.RenderBeginTag(HtmlTextWriterTag.Button)          '<input>
            writer.Write("&nbsp;-&gt;&nbsp;")
            ...
            writer.Write("<br>")
            writer.AddAttribute(HtmlTextWriterAttribute.Onclick, String.Format("switchAll(this.form.{0}_SrcList, this.form.{0}_DstList)", ClientID))
            writer.AddAttribute(HtmlTextWriterAttribute.Class, "listPickerArrow")
            writer.RenderBeginTag(HtmlTextWriterTag.Button)         '<input>
            writer.Write("-&gt;&gt;")
            writer.RenderEndTag()           '</input>
            ...
            'writer.RenderEndTag()
            writer.Write("<br>")
            writer.AddAttribute(HtmlTextWriterAttribute.Onclick, String.Format("switchList(this.form.{0}_DstList, this.form.{0}_SrcList)", ClientID))
            writer.AddAttribute(HtmlTextWriterAttribute.Class, "listPickerArrow")
            writer.RenderBeginTag(HtmlTextWriterTag.Button)         ' <input>
            writer.Write("&nbsp;&lt;-&nbsp;")
            writer.RenderEndTag()           '</input>
            ...
            'writer.RenderEndTag()
            writer.Write("<br>")
            writer.AddAttribute(HtmlTextWriterAttribute.Onclick, String.Format("switchAll(this.form.{0}_DstList, this.form.{0}_SrcList)", ClientID))
            writer.AddAttribute(HtmlTextWriterAttribute.Class, "listPickerArrow")
            writer.RenderBeginTag(HtmlTextWriterTag.Button)         '<input>
            writer.Write("&lt;&lt;-")
            writer.RenderEndTag()           '</input>
        ...
        Sub RenderDownlevelContent(ByVal writer As HtmlTextWriter)
            ...
            btnAddAllItem.RenderControl(writer)
            ...
            ' Delete All Button
            writer.Write("<br>")
            btnRemoveAllItem.RenderControl(writer)
            writer.RenderEndTag()
    ...
    <ParseChildren(True), Designer(GetType(CustomDesigner)), ToolboxData("<{0}:AlphaPicker runat=server />")> _
