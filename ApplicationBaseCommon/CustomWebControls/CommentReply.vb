...
Namespace CustomWebControls
    ...
    Public Class CommentReply
        ...
        Private _replyUrl As String = "Comments_AddComment.aspx?id={0}"
        ...
        Protected Overrides Sub AddAttributesToRender(ByVal writer As HtmlTextWriter)
            ...
            Dim replyLink As String = String.Format(_replyUrl, objContentInfo.ContentPageID)
        ...
        Protected Overrides Sub Render(ByVal writer As HtmlTextWriter)
            ...
            If objAccountProfileInfo.MayEdit OrElse Array.IndexOf(objModuleProfileInfo.EditRoles, "Authenticated") <> -1 Then
                MyBase.Render(writer)
            End If
        End Sub 'Render
