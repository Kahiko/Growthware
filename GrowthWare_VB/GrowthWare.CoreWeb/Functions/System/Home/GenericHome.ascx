<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="GenericHome.ascx.vb" Inherits="GrowthWare.CoreWeb.GenericHome" %>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" style="FONT: 8pt verdana, arial">
	<tr>
		<td align="left" valign="top" style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:0px; PADDING-TOP:0px">
			<asp:Image ID="SideImage" ImageUrl='<%=ResolveUrl( "~/Public/Images/GrowthWare/Misc/sidebar_blue.gif" )%>' Runat="server"></asp:Image>
		</td>
