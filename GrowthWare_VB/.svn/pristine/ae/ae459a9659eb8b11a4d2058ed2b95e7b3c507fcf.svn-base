...
Namespace BusinessLogicLayer
	...
	Public Interface IBAccounts
		...
		''' </code>
		''' </example>
		Sub Delete(ByVal AccountId As Integer)
		...
		Function GetProfile(ByVal Account As String) As MAccountProfile
		...
		''' </remarks>
		Function GetAccounts(ByVal Profile As MAccountProfile) As Collection(Of MAccountProfile)
		...
		Sub Save(ByRef Profile As MAccountProfile, ByVal SaveRoles As Boolean, ByVal SaveGroups As Boolean)
