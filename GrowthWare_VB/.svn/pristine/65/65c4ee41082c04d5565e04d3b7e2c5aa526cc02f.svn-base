...
Namespace Profiles
	...
	Public MustInherit Class MSecurity
		...
		''' Return roles associated with the "Add" permission.
		''' </summary>
		Public ReadOnly Property DerivedAddRoles() As Collection(Of String) Implements IMSecurityInfo.DerivedAddRoles
			Get
		...
		''' </summary>
		Public ReadOnly Property DerivedDeleteRoles() As Collection(Of String) Implements IMSecurityInfo.DerivedDeleteRoles
			Get
		...
		''' </summary>
		Public ReadOnly Property DerivedEditRoles() As Collection(Of String) Implements IMSecurityInfo.DerivedEditRoles
			Get
		...
		''' </summary>
		Public ReadOnly Property DerivedViewRoles() As Collection(Of String) Implements IMSecurityInfo.DerivedViewRoles
			Get
