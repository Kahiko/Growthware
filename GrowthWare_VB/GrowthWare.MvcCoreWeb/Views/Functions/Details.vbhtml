...
<fieldset>
    ...
    <div class="display-label">PermissionColumn</div>
    <div class="display-field">
        @Html.DisplayFor(Function(model) model.PermissionColumn)
    </div>

    <div class="display-label">RoleColumn</div>
    <div class="display-field">
        @Html.DisplayFor(Function(model) model.RoleColumn)
    </div>
