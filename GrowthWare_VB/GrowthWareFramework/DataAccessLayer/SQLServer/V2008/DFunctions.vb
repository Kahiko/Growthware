...
#Region "Pulbic Methods"
		Public Sub Delete() Implements IDFunction.Delete
			...
			{
			  New SqlParameter("@P_Function_SeqID", Profile.Id), _
		...
		Public Function Save() As Integer Implements IDFunction.Save
			...
			Dim mParameters() As SqlParameter =
			 {
			  MyBase.GetSqlParameter("@P_Function_SeqID", m_Profile.Id, ParameterDirection.InputOutput),
			...
			mRetInt = MyBase.GetParameterValue("@P_Function_SeqID", mParameters)
			Return mRetInt
		End Function

		Public Sub SaveGroups(ByVal permission As PermissionType) Implements IDFunction.SaveGroups
			checkValid()
			Dim mCommaSeporatedString As String = m_Profile.GetCommaSeporatedGroups(permission)
			Dim mParameters() As SqlParameter =
			 {
			  New SqlParameter("@P_Function_SeqID", Profile.Id),
			  ...
			  New SqlParameter("@P_Added_Updated_By", MyBase.GetAddedUpdatedBy(Profile))
			 }
