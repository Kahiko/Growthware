...
Namespace DataAccessLayer
	Public Interface IDFunction
		...
		' ''' <returns>DataTable</returns>
		'Function GetGroups(ByVal permission As PermissionTypes) As DataTable
		...
		' ''' <param name="permission">PermissionTypes</param>
		' ''' <returns>DataTable</returns>
		'Function GetRoles(ByVal permission As PermissionTypes) As DataTable
		...
		' ''' <returns></returns>
		' ''' <remarks></remarks>
		'Function GetAllRoles() As DataTable
		...
		' ''' <returns></returns>
		' ''' <remarks></remarks>
		'Function GetAllGroups() As DataTable
