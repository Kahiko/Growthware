<%@ Control Language="vb" enableViewState="false" AutoEventWireup="false" Codebehind="ApplicationInformation.ascx.vb" Inherits="BaseApplication.ApplicationInformation" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
