Imports Common.BaseSecurity
Imports DALOracle
Imports System.Configuration
Imports System.Data.OracleClient

Public Class ODALTestOracle
	Implements DALInterface.ITestOracle

	Private _ConnectionString As String = String.Empty

	Public Function GetAddresses(ByRef dstAddresses As System.Data.DataSet) As System.Data.DataSet Implements DALInterface.ITestOracle.GetAddresses
		Try
			...
			reader = OracleDAL.OraHelper.ExecuteReader(myConnectionString, CommandType.Text, commandText)
	...
	Private Function ConnectionString() As String
		If _ConnectionString = String.Empty Then
			...
			_ConnectionString = Common.ConnectionHelper.GetConnectionString("OracleDAL")
		End If
