...
#End Region
    ...
    Public Sub CopyModuleSecurity(ByVal ADDUPD_BY As Integer, ByVal SourceBU As Integer, ByVal TargetBU As Integer) Implements IAppModules.CopyModuleSecurity
        OracleHelper.ExecuteNonQuery(ConnectionString, _
         CommandType.StoredProcedure, "ZB_SECURITY_PKG.ZBP_COPY_BU_MOD_SEC", _
         New OracleParameter() { _
         New OracleParameter("@P_SourceBU", SourceBU), _
         New OracleParameter("@P_TargetBU", TargetBU), _
         New OracleParameter("@P_ADDUPD_BY", ADDUPD_BY)})
    End Sub
End Class