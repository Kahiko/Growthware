...
Public Class AppLogger
	...
	'*********************************************************************
	Private Sub init()
		myLayout.ConversionPattern = ConfigurationManager.AppSettings("ConversionPattern")
		myAppender.AppendToFile = CBool(ConfigurationManager.AppSettings("AppendToFile"))
		Dim InitialLogPriority As log4net.Priority
		Select Case ConfigurationManager.AppSettings(BaseHelper.Environment & "LogPriority").ToLower
			Case "debug"
	...
	Public Shared Function GetInstance() As AppLogger
		...
		Finally
			...
			LogFileName = ConfigurationManager.AppSettings("LogPath") & Format(Now, "MMddyyyy") & ".txt"
