	...
	Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		If HttpContext.Current.User.Identity.IsAuthenticated Then
			If Not IsPostBack Then
                litAppDisplayedName.Text = BaseSettings.AppDisplayedName
                ...
                litSelectedLocation.Text = "Selected " & BaseSettings.BusinessUnitTranslation & " is " & ClientChoicesState(MClientChoices.BusinessUnitName)
			End If
		End If
	End Sub
