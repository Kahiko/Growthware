...
<head id="head" runat="server">
    ...
    <style id="CustomStyles" runat="server" type="text/css">
    </style>
    <link href="~/UI/Default/Styles/Main.css" type="text/css" rel="stylesheet" />
    <link href="~/UI/MedMetrics/Styles/styles.css" type="text/css" rel="stylesheet" />
    <link href="~/UI/MedMetrics/Styles/HierarchalMenu.css" type="text/css" rel="stylesheet" />
