<%@ Control Language="vb" enableViewState="false" AutoEventWireup="false" Inherits="ApplicationBase.ApplicationInformation" Codebehind="ApplicationInformation.ascx.vb" %>
