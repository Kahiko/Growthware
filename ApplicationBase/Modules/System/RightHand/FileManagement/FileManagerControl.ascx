<%@ Control Language="vb" AutoEventWireup="false" Inherits="ApplicationBase.FileManagerControl" Codebehind="FileManagerControl.ascx.vb" %>
<SCRIPT>
function selectAll(){
	var btn = document.getElementById('ctl00_RightHandModulesLoader_ctl00_cmdSelect');
	var checked = false;
