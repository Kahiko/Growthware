<%@ Control Language="vb" AutoEventWireup="false" Inherits="ApplicationBase.SelectStates" Codebehind="SelectStates.ascx.vb" %>
			    ...
			    <tr>
			        ...
			        <td>
			            <asp:dropdownlist Visible="True" id="dropSearchBy" Runat="Server" AutoPostBack="True">
				            ...
				            <asp:ListItem Text="Description" Value="LongName" />
			            </asp:dropdownlist>
			        </td>
			        <td>
		...
		<td align="left">
			...
			<asp:datagrid id="dgResults" runat="server" cssclass="searchResults" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" ForeColor="#333333" GridLines="Both">
				<Columns>
					...
					<asp:BoundColumn SortExpression="State" DataField="State" HeaderText="State" >
					    <HeaderStyle Wrap="false" />
                        <ItemStyle Wrap="False" />
                    </asp:BoundColumn>
					<asp:BoundColumn SortExpression="LongName" DataField="LongName" HeaderText="Description" >
					    <HeaderStyle Wrap="false" />
                        <ItemStyle Wrap="False" />
                    </asp:BoundColumn>
				</Columns>
