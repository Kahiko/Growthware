<%@ Control Language="vb" AutoEventWireup="false" Inherits="ApplicationBase.SelectGroups" Codebehind="SelectGroups.ascx.vb" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td align="center">
			...
			<asp:datagrid id="dgResults" runat="server" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" ForeColor="#333333" GridLines="Both">
				<Columns>
					<asp:TemplateColumn>
						<HeaderTemplate>
		                    Details
					...
					<asp:BoundColumn SortExpression="Name" DataField="Name" HeaderText="Name" >
					    <HeaderStyle Wrap="false" />
                        <ItemStyle Wrap="False" />
                    </asp:BoundColumn>
					<asp:BoundColumn SortExpression="Description" DataField="Description" HeaderText="Description" >
					    <HeaderStyle Wrap="false" />
                        <ItemStyle Wrap="False" />
                    </asp:BoundColumn>
				</Columns>
