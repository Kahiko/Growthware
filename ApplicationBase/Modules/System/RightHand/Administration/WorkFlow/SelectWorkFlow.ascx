<%@ Control Language="vb" AutoEventWireup="false" Inherits="ApplicationBase.SelectWorkFlow" Codebehind="SelectWorkFlow.ascx.vb" %>
			    ...
			    <tr>
			        ...
			        <td>
			            <asp:dropdownlist Visible="True" id="dropSearchBy" Runat="Server" AutoPostBack="True">
				            <asp:ListItem Text="Work Flow Name" Value="WORK_FLOW_NAME" />
			            </asp:dropdownlist>
			        </td>
			        <td>
