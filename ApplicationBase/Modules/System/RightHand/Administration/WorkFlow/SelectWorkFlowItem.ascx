<%@ Control Language="vb" AutoEventWireup="false" Inherits="ApplicationBase.SelectWorkFlowItem" Codebehind="SelectWorkFlowItem.ascx.vb" %>
			    ...
			    <tr>
			        ...
			        <td>
			            <asp:dropdownlist Visible="True" id="dropSearchBy" Runat="Server" AutoPostBack="True">
				            <asp:ListItem Text="Work Flow Name" Value="Name" />
			            </asp:dropdownlist>
			        </td>
			        <td>
		...
		<td align="left">
			...
			<asp:datagrid id="dgResults" runat="server" cssclass="searchResults" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" ForeColor="#333333" GridLines="Both">
				<Columns>
					...
					<asp:BoundColumn SortExpression="WORK_FLOW_NAME" DataField="WORK_FLOW_NAME" HeaderText="Name">
					    <HeaderStyle Wrap="false" />
                        <ItemStyle Wrap="False" />
					</asp:BoundColumn>
					<asp:BoundColumn SortExpression="ORDER_ID" DataField="ORDER_ID" HeaderText="Order">
					    <HeaderStyle Wrap="false" />
                        <ItemStyle Wrap="False" />
					</asp:BoundColumn>
					<asp:BoundColumn SortExpression="MODULE_ACTION" DataField="MODULE_ACTION" HeaderText="Module Action">
					    <HeaderStyle Wrap="false" />
                        <ItemStyle Wrap="False" />
					</asp:BoundColumn>
				</Columns>
