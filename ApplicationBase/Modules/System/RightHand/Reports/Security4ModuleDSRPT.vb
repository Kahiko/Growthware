...
Public Class Security4ModuleDSRPT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Security4ModuleDSRPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSecurity4ModuleDSRPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Security4ModuleDSRPT = New Security4ModuleDSRPT
        rpt.Site = Me.Site
        Return rpt
    End Function
