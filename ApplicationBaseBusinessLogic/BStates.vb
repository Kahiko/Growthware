...
Public Class BStates
	...
	'Private Shared iBaseDAL As IStates = FStates.Create(Configuration.ConfigurationManager.AppSettings("BaseDAL"))
    Private Shared iBaseDAL As IStates = FactoryObject.Create(BaseSettings.applicationBaseDAL(), "DStates")
