...
Public Class BDropBox
	'Private Shared iBaseDAL As IDropBox = FDropBox.Create(Configuration.ConfigurationManager.AppSettings("BaseDAL"))
    Private Shared iBaseDAL As IDropBox = FactoryObject.Create(BaseSettings.applicationBaseDAL, "DDropBox")
	...
	Public Shared Sub AddDropBoxRoles(ByVal DROP_BOX_SEQ_ID As Integer, ByVal BUSINESS_UNIT_SEQ_ID As Integer, ByVal moduleRoleType As MRoleType.value, ByVal roles() As String, Optional ByVal ACCOUNT_SEQ_ID As Integer = 1)
