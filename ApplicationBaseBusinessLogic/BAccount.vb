...
Public Class BAccount
	'Private Shared iBaseDAL As IAccount = FAccount.Create(Configuration.ConfigurationManager.AppSettings("BaseDAL"))
    Private Shared iBaseDAL As IAccount = FactoryObject.Create(BaseSettings.applicationBaseDAL(), "DAccount")
