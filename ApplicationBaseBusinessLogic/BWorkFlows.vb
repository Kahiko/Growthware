...
Public Class BWorkFlows
	'Private Shared iBaseDAL As IWorkFlows = FWorkFlows.Create(Configuration.ConfigurationManager.AppSettings("BaseDAL"))
    Private Shared iBaseDAL As IWorkFlows = FactoryObject.Create(BaseSettings.applicationBaseDAL(), "DWorkFlows")
