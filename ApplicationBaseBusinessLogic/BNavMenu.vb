...
Public Class BNavMenu
	'Private Shared iBaseDAL As INavMenu = FNavMenu.Create(Configuration.ConfigurationManager.AppSettings("BaseDAL"))
    Private Shared iBaseDAL As INavMenu = FactoryObject.Create(BaseSettings.applicationBaseDAL, "DNavMenu")
	...
	Public Shared Sub GetRootLinks(ByRef YourDataSet As DataSet, ByVal ACCOUNT_SEQ_ID As Integer, ByVal BUSINESS_SEQ_ID As Integer)
