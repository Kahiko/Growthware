...
try{
	if(document.all){
		...
		panels = document.getElementsByTagName("table");
	}
}catch(e){
	//alert(e);
}
	...
	try{
		...
		try{
			if (!NiftyCheck()){
				...
				RoundedTop("div#roundedCorner","white",SubheadColor);
			}
		}catch(e){
			//do nothing
...
function switchList(FromBox, ToBox){
/*
...
*/
	...
	var objFromBox = document.getElementById(FromBox)
	var objToBox = document.getElementById(ToBox)
	var i;
