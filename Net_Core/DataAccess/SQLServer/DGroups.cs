...
#region Constructors
    ...
    public async Task<DataTable> GroupRoles()
    {
        ...
        SqlParameter[] mParameters = [ 
            new ("@P_SecurityEntitySeqId", GroupRolesProfile.SecurityEntityID), 
            new ("@P_GroupSeqId", GroupRolesProfile.GroupSeqId) 
        ];
    ...
    public async Task<bool> UpdateGroupRoles()
    {
        ...
        SqlParameter[] mParameters = [
            new ("@P_GroupSeqId", GroupRolesProfile.GroupSeqId), 
            new ("@P_SecurityEntitySeqId", GroupRolesProfile.SecurityEntityID), 
            new ("@P_Roles", GroupRolesProfile.Roles??""), 
            new ("@P_Added_Updated_By", GetAddedUpdatedBy(GroupRolesProfile, GroupRolesProfile.GroupSeqId)) 
        ];
