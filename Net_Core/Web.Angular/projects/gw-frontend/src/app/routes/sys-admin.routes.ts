...
import { LineCountComponent, NaturalSortComponent, SearchDBLogsComponent } from '@growthware/core/sys-admin';
...
export const sysAdminRoutes: Routes = [
	...
	{ path: 'searchdblogs', component: SearchDBLogsComponent, canActivate: [AuthGuard] },
];