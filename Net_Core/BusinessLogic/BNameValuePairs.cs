...
#region Constructors
    ...
    public async Task UpdateGroups(int nameValuePairId, int SecurityEntityID, string commaSeparatedGroups, MNameValuePair nameValuePairProfile)
    {
        if (DatabaseIsOnline()) await m_DNameValuePairs.UpdateGroups(nameValuePairId, SecurityEntityID, commaSeparatedGroups, nameValuePairProfile);
    }
    ...
    /// <param name="nameValuePairProfile">MNameValuePair.</param>
    public async Task UpdateRoles(int nameValuePairId, int SecurityEntityID, string commaSeparatedRoles, MNameValuePair nameValuePairProfile)
    {
        if (DatabaseIsOnline()) await m_DNameValuePairs.UpdateRoles(nameValuePairId, SecurityEntityID, commaSeparatedRoles, nameValuePairProfile);
    }
}
