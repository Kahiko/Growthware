...
const routes: Routes = [
  ...
  { path: 'selectasecurityentity', loadComponent: () => import('@Growthware/features/security-entities/c/select-security-entity/select-security-entity.component').then(m => m.SelectSecurityEntityComponent), canActivate: [AuthGuard] },
