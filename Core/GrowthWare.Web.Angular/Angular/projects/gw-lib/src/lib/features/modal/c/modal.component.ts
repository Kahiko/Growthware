...
export class ModalComponent implements OnInit {
  ...
  public cancelBtn: ICallbackButton = new CallbackButton(this.modalId + '_CancelBtn', this.modalId + '_CancelBtn');
  public closeBtn: ICallbackButton = new CallbackButton(this.modalId + '_CloseBtn', this.modalId + '_CloseBtn', 'btn btn-secondary', 'Close', false);
  public okBtn: ICallbackButton = new CallbackButton(this.modalId + '_OkBtn', this.modalId + '_OkBtn', 'btn btn-primary', 'OK', true);;
