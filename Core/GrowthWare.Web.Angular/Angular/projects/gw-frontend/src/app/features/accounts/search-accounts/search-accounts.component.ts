...
export class SearchAccountsComponent implements OnInit {
  private _Columns: string = "AccountSeqId, Name, First_Name, Last_Name, Email, Added_Date, Last_Login";
  ...
  ngOnInit(): void {
    this._SearchCriteria = new SearchCriteria(this._Columns, "Name", "asc", 10, 1, "1=1");
