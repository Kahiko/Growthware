...
public static class TreeHelper
{
    ...
    /// </param>
    public static IList<T> GetHierarchicalList<T>(this IEnumerable<T> flatNodeList) where T : class, ITreeNode<T>
    {
    ...
    public static List<T> ConvertToFlatArray<T>(this IEnumerable<T> trees) where T : class, ITreeNode<T>
    {
    ...
    public static T FindDescendant<T>(this T searchRoot, int id) where T : class, ITreeNode<T>
    {
    ...
    /// Returns null if the node cannot be found.</summary>
    public static T FindTreeNode<T>(this IEnumerable<T> trees, int id) where T : class, ITreeNode<T>
    {
    ...
    /// </example>
    public static bool HasHeirachyLoop<T>(this T node) where T : class, ITreeNode<T>
    {
        ...
        where T : class, ITreeNode<T>
    {
        ...
        {
            throw new ArgumentException("The children of " + parameterName + " is null. Have you populated the tree fully by calling TreeHelper<T>.GetHierarchicalList(IEnumerable<T> flatNodeList)?", parameterName);
        }
    }
