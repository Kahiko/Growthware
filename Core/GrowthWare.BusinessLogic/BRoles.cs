...
namespace GrowthWare.BusinessLogic
{
    ...
    public class BRoles : BaseBusinessLogic
    {
        ...
        /// 
        /// BRoles mBRoles = BRoles = New BRoles(MSecurityEntity, ConfigSettings.CentralManagement);
        /// ]]>
        /// </code>
        /// <code language="C#">
        /// <![CDATA[
        ...
        /// MSecurityEntity.ConnectionString = ConfigSettings.ConnectionString
        /// 
        /// Dim mBRoles As BRoles = New BRoles(MSecurityEntity, ConfigSettings.CentralManagement)
        /// ]]>
        /// </code>
        /// </example>
        public BRoles(MSecurityEntity securityEntityProfile, bool centralManagement)
        {
