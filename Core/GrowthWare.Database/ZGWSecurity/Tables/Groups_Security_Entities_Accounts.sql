CREATE TABLE [ZGWSecurity].[Groups_Security_Entities_Accounts] (
    ...
    CONSTRAINT [FK_Groups_Security_Entities_Accounts_Groups_Security_Entities] FOREIGN KEY ([Groups_Security_EntitiesSeqId]) REFERENCES [ZGWSecurity].[Groups_Security_Entities] ([Groups_Security_EntitiesSeqId]) ON DELETE CASCADE ON UPDATE CASCADE
);
