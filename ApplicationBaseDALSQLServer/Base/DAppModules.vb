...
#End Region
	...
	Public Sub AddModuleGroups(ByVal MODULE_SEQ_ID As Integer, ByVal BUSINESS_UNIT_SEQ_ID As Integer, ByVal moduleGroupType As MGroupType.value, ByVal groups() As String, Optional ByVal Account_Seq_id As Integer = 1) Implements IAppModules.AddModuleGroups
		Dim group As String
	...
	Public Sub CopyModuleSecurity(ByVal ADDUPD_BY As Integer, ByVal SourceBU As Integer, ByVal TargetBU As Integer) Implements ApplicationBase.Interfaces.IAppModules.CopyModuleSecurity
		SqlHelper.ExecuteNonQuery(ConnectionString, _
		 CommandType.StoredProcedure, "ZBP_COPY_BU_MOD_SEC", _
		 New SqlParameter() { _
		 New SqlParameter("@P_SourceBU", SourceBU), _
		 New SqlParameter("@P_TargetBU", TargetBU), _
		 New SqlParameter("@P_ADDUPD_BY", ADDUPD_BY)})
	End Sub
End Class