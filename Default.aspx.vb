...
#Region " Web Form Designer Generated Code "
	...
	End Sub
	Protected WithEvents plcPage As System.Web.UI.WebControls.PlaceHolder
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		...
		If Not BaseHelper.PageSupport Then
		...
		Try
			myControlSource = "UI/" & BaseHelper.UI(ClientChoicesState(MClientChoices.BusinessUnitID)) & "/Default.ascx"
			myPage = Me.LoadControl(myControlSource)
			plcPage.Controls.Add(myPage)
		Catch ex As Exception
			Dim myErrorMSG As String = String.Empty
			myErrorMSG = "A critical error has occured within the UI.  The UI is: " & BaseHelper.UI(ClientChoicesState(MClientChoices.BusinessUnitID))
