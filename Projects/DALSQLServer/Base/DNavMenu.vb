...
Public Class DNavMenu
    ...
    Public Function GetNavType(ByVal dsNavType As System.Data.DataSet) As System.Data.DataSet Implements INavMenu.GetNavType
        Try
            dsNavType = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "ZBP_get_Nav_Types")
    ...
    Public Function GetNavLinks(ByVal MenuDataSet As DataSet, ByVal ACCOUNT_SEQ_ID As Integer, ByVal BUSINESS_UNIT_SEQ_ID As Integer) As DataSet Implements INavMenu.GetNavLinks
        Try
            MenuDataSet = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "ZBP_get_Left_NavLinks", New SqlParameter() { _
            New SqlParameter("@P_ACCOUNT_SEQ_ID", ACCOUNT_SEQ_ID), _
            New SqlParameter("@P_BUSINESS_UNIT_SEQ_ID", BUSINESS_UNIT_SEQ_ID)})
        Catch ex As Exception
            Throw ex
        End Try
        Return MenuDataSet
    ...
    Public Function GetLineMenuLinks(ByVal MenuDataSet As DataSet, ByVal ACCOUNT_SEQ_ID As Integer, ByVal BUSINESS_UNIT_SEQ_ID As Integer) As DataSet Implements INavMenu.GetLineMenuLinks
        Try
            MenuDataSet = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "ZBP_get_LineMenu_NavLinks", New SqlParameter() { _
            New SqlParameter("@P_ACCOUNT_SEQ_ID", ACCOUNT_SEQ_ID), _
            New SqlParameter("@P_BUSINESS_UNIT_SEQ_ID", BUSINESS_UNIT_SEQ_ID)})
        Catch ex As Exception
            Throw ex
    ...
    Public Function GetHierarchicalMenuData(ByRef retDataset As System.Data.DataSet, ByVal BUSINESS_UNIT_SEQ_ID As Integer, ByVal ACCOUNT_SEQ_ID As Integer) As System.Data.DataSet Implements INavMenu.GetHierarchicalMenuData
        Try
            retDataset = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "ZBP_get_Hierarchical_Menu_Data", New SqlParameter() {New SqlParameter("@P_BUSINESS_UNIT_SEQ_ID", BUSINESS_UNIT_SEQ_ID), New SqlParameter("@P_ACCOUNT_SEQ_ID", ACCOUNT_SEQ_ID)})
        Catch ex As Exception
            Throw ex
        End Try
        Return retDataset
    ...
    Public Sub GetRootLinks(ByRef YourDataSet As System.Data.DataSet, ByVal ACCOUNT_SEQ_ID As Integer, ByVal BUSINESS_UNIT_SEQ_ID As Integer) Implements INavMenu.GetRootLinks
        Try
            YourDataSet = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "ZBP_get_Root_Links", New SqlParameter() {New SqlParameter("@P_BUSINESS_UNIT_SEQ_ID", BUSINESS_UNIT_SEQ_ID), New SqlParameter("@P_ACCOUNT_SEQ_ID", ACCOUNT_SEQ_ID)})
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
