...
Namespace Base.SQLServer
    Public Class BRoles
		'Private Shared iBaseDAL As IRoles = FRoles.Create(Configuration.ConfigurationSettings.AppSettings("BaseDAL"))
		Private Shared iBaseDAL As IRoles = AbstractFactory.Create(Configuration.ConfigurationSettings.AppSettings("BaseDAL"), "DRoles")
