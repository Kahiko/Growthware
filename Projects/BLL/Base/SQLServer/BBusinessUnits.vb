...
Namespace Base.SQLServer
    Public Class BBusinessUnits
		'Private Shared iBaseDAL As IBusinessUnits = FBusinessUnits.Create(Configuration.ConfigurationSettings.AppSettings("BaseDAL"))
		Private Shared iBaseDAL As IBusinessUnits = AbstractFactory.Create(Configuration.ConfigurationSettings.AppSettings("BaseDAL"), "DBusinessUnits")
